    ...
    <main className="min-h-screen bg-[#100b12] text-white">
      ...
      <div className="mx-auto max-w-7xl px-5">
        <section className="relative overflow-hidden py-14 md:py-20">
          ...
          <div className="relative max-w-3xl">
            <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-[#ff78b9]">
              Um cantinho para histórias inventadas
            </p>
        ...
        <StorySection
          ...
          subtitle="Novas histórias acabaram de chegar ao Nooklie"
      ...
      <footer className="border-t border-white/10 bg-[#0b080d]">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-5 py-8 text-sm text-white/35 md:flex-row md:items-center md:justify-between">
          ...
          <p>Um cantinho para histórias inventadas.</p>
        </div>
      </footer>
    </main>
  );
  ...
  return (
    <section className="mb-16">
      <div className="mb-6 flex flex-col justify-between gap-2 md:flex-row md:items-end">
        ...
        <button
          type="button"
          className="w-fit text-sm font-semibold text-[#ff78b9] hover:underline"
        >
          Ver tudo
        </button>
      </div>
    ...
    <article className="group overflow-hidden rounded-3xl border border-white/10 bg-[#191219] transition hover:-translate-y-1 hover:border-[#ff78b9]/30">
      ...
      <div className="p-5">
        ...
        <div className="mt-5 flex items-center justify-between border-t border-white/5 pt-4">
          ...
          <button
            type="button"
            className="rounded-full border border-white/10 px-4 py-2 text-xs font-semibold transition hover:border-[#ff78b9]/40 hover:text-[#ff78b9]"
          >
            Ler história
          </button>
        </div>
