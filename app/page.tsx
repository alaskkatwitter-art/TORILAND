...
const recentStories: Story[] = [
  {
    ...
    author: 'Alys',
    description: 'Uma princesa, uma guerra e um casamento que nunca deveria acontecer.',
    genre: 'Fantasia',
    color: '#54302f',
  },
  {
    ...
    author: 'Mira',
    description: 'Eles vivem na mesma cidade, mas parecem viver em mundos diferentes.',
    genre: 'Romance',
    color: '#3f3152',
  },
  {
    ...
    author: 'Elena',
    description: 'Uma promessa feita na infância retorna muitos anos depois.',
    genre: 'Drama',
    color: '#314552',
  },
];
